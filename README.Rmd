...
> Hilden, S., Lee, S., Zauner, J., & Spitschan, M.,  (2025). Personal light exposure dataset for Munich, Germany (Version 1.0.1) [Data set]. URL: https://github.com/MeLiDosProject/HildenEtAl_Dataset_2025. DOI: doi.org/10.5281/zenodo.16893901
...
![Summary table of personal light exposure (eye-level data)](output/tables/table_summary.png)
...
## Individual
This folder contains individual-level data for N=10 participant, each stored in a separate folder named after the participant ID (PID). The data within each participant folder follows the following structure. 
