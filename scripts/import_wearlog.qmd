...
#import files
data <- read_csv2(files[c(2, 4:10)], show_col_types = FALSE) |> drop_na(redcap_repeat_instance)
data2 <- read_csv2(files[c(1, 3)], show_col_types = FALSE) |> drop_na(redcap_repeat_instance)
